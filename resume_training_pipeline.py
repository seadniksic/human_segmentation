...
model_path = "checkpoints\\long_trains\\UNet_Standard_BatchNorm3_copy.pt"

model_top_level_name = "UNet"
model_specific_name = "batchnorm_pretrained_then_augmented"
...
train_params = {"path_to_model": model_path, "epochs": 300, "loss_function": criterion,
         "optimizer": optimizer, "scheduler": scheduler,
         "save_dir": "checkpoints\\long_trains\\", "use_optim_state_dict": False}

model.resume_training(**train_params)
